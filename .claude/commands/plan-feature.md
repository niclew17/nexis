...
- Find relevant documentation in ai-context/reference, docs/, ai_docs/, or ai-wiki if available
...
- Review the inefficiencies folder in ai-context
- Identify any inefficiencies that exist within the current codebase as they relate to this feature
- Document them and suggest improvements for the feature implementation
- Always update the `INEFFICIENCIES.md` file under `ai-context` if new inefficiencies are identified during this phase by adding a new entry to the file. Make sure if you update the file that you include a reference to the feature you are working on.
- Examples of innefficiencies include:
  - Code that could be refactored to be more efficient
  - Code that could be simplified
  - Code that could be better organized
  - Inefficient database queries that could be optimized (Index usage, query patterns, etc.)
  - Inefficient API calls that could be reduced or batched
  - Inefficient data structures or algorithms
  - Inefficient use of resources (memory, CPU, etc.)
  - Inefficient caching strategies
  - Inefficient error handling
  - Inefficient logging
  - Any other inefficiencies you identify

**7: Security Considerations**

- Review the security folder in ai-context
- Identify any security concerns that exist within the current codebase as they relate to this feature
- Document them and suggest improvements for the feature implementation
- Always update the `SECURITY.md` file under `ai-context` if new security concerns are identified during this phase by adding a new entry to the file. Make sure if you update the file that you include a reference to the feature you are working on.
- Examples of security concerns include:
  ...
  - Insecure logging
  - Any other security concerns you identify
...
**Filename**: `ai-context/plans/{kebab-case-descriptive-name}.md`

- Replace `{kebab-case-descriptive-name}` with short, descriptive feature name
- Examples: `add-user-authentication.md`, `implement-search-api.md`, `refactor-database-layer.md`

**Directory**: Create `ai-context/plans` if it doesn't exist
