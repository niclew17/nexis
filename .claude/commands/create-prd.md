...
Place in the `ai-context` directory. If this directory doesn't exist, create it, then add the PRD.md file to the directory.
...
- Create `ai-context` directory under project root if it doesn't exist
- Create a folder called `plans` under ai-context
- Create a file called `INEFFICIENCIES.md` under ai-context
- Create a file called `SECURITY.md` under ai-context
