...
Place in the `ai-context` directory. If this directory doesn't exist, create it, then add the CLAUDE.md file to the directory.
...
4. Optionally create reference docs in `ai-context/reference/`
```
