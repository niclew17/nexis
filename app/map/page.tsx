...
async function loadStartups(): Promise<Startup[]> {
  ...
  const { data, error } = await supabase
    .from("startups")
    .select(
      "slug, linkedin_url, name, address, lat, lng, description, website, domain, logo_url, stage, employees, section, year_founded, hiring, claimed_by, claimed_at, jobs, photos, county"
    )
