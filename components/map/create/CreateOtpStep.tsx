    ...
    >
      <div>
        ...
        >
          ...
          <span style={{ color: COLORS.accent }}>{email}</span>. Enter it below
      ...
      >
        <button
          ...
          style={{
            ...
            cursor:
              isSubmitting || token.length !== 6 ? "not-allowed" : "pointer",
